...
| 背景 | `#0F172A` 深色 | **v1 单主题暗色（不提供切换）**——背景用 `#0d1117` 三层深色面板（#0a0e14 / #0d1117 / #161b22）+ 8-12% 主色 alpha glow | 用户 2026-06-10 拍板：实施最快，避免分散精力；暗色风符合 dev 工具桌面的常见范式（VSCode / Cursor / Linear）；非技术用户友好通过"清晰文字 + 二次确认 + 零术语"保证，不靠浅色 |
