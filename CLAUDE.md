...
>
> **最后更新**：2026-07-20（v2.0 + v2.4 + v2.5 + v2.6 + v3.x + v0.3.0 + v0.5.3 + v0.6.0 + v0.7.0 + v0.7.1 + v0.7.2 + v0.7.3 + v0.7.4 + v0.7.5 + v0.7.6 + v0.7.7 + v0.7.8 + v0.7.9 + v0.7.10 + v0.7.11 + v0.7.12 + v0.7.13 + v0.7.14 + v0.7.15 + v0.7.16 + v0.7.17 + v0.7.18 + v0.7.19 + v0.7.20 + v0.7.21）。详细版本演进看 [AGENTS.md](./AGENTS.md) 顶部。
